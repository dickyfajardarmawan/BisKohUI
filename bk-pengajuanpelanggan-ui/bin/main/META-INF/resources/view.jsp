...
<div class="container my-3">
	<div class="card">
		<div style="background-color: #830000; color: #fff"
			class="card-header">
			<h4 class="m-0">
				<i class="fa fa-th-list"></i> Pengajuan Pelanggan
			</h4>
		</div>
		<div class="card-body">
			<form>
				...
				<tbody>
					...
					<th scope="row">1010101010</th>
						...
						<td><a href="javascript:void(0)" onclick="document.getElementById('id01').style.display='block'" data-toggle="tooltip"
							data-placement="top" title="Pengajuan Pelanggan"><i class="fa fa-cog"></i></a></td>
					</tr>
				</tbody>
			</table>
		...
		<div class="w3-container pb-3">
			<form>
				...
				<div class="text-right">
					...
					<button type="button" onclick="document.getElementById('id01').style.display='none'" class="btn btn-danger">Tambah</button>
				</div>
			</form>
		</div>
	</div>
