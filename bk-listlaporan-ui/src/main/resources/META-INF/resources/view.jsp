            ...
            <div class="card-body">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><a href="javascript:void(0)" onclick="document.getElementById('id01').style.display='block'" data-toggle="tooltip" data-placement="top" title="Master Data Pelanggan"><i class="fa fa-cog"></i></a></td>
                        </tr>
                        <tr>
                            <th scope="row">Master Data Produk</th>
                            <td><a href="javascript:void(0)" onclick="document.getElementById('id02').style.display='block'" data-toggle="tooltip" data-placement="top" title="Master Data Produk"><i class="fa fa-cog"></i></a></td>
                        </tr>
                        <tr>
                            <th scope="row">Master Data Penjualan</th>
                            <td><a href="javascript:void(0)" onclick="document.getElementById('id03').style.display='block'" data-toggle="tooltip" data-placement="top" title="Master Data Penjualan"><i class="fa fa-cog"></i></a></td>
                        </tr>
                        <tr>
                            <th scope="row">Master Data Pembelian</th>
                            <td><a href="javascript:void(0)" onclick="document.getElementById('id04').style.display='block'" data-toggle="tooltip" data-placement="top" title="Master Data Pembelian"><i class="fa fa-cog"></i></a></td>
                        </tr>
                        <tr>
                            <th scope="row">Master Data Akutansi</th>
                            <td><a href="javascript:void(0)" onclick="document.getElementById('id05').style.display='block'" data-toggle="tooltip" data-placement="top" title="Master Data Akutansi"><i class="fa fa-cog"></i></a></td>
                        </tr>
                        <tr>
                            <th scope="row">Master Data Pengiriman</th>
                            <td><a href="javascript:void(0)" onclick="document.getElementById('id06').style.display='block'" data-toggle="tooltip" data-placement="top" title="Master Data Pengiriman"><i class="fa fa-cog"></i></a></td>
                        </tr>
                        <tr>
                            <th scope="row">Master Data Gudang</th>
                            <td><a href="javascript:void(0)" onclick="document.getElementById('id07').style.display='block'" data-toggle="tooltip" data-placement="top" title="Master Data Gudang"><i class="fa fa-cog"></i></a></td>
                        </tr>
                    </tbody>
                </table>
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination justify-content-center">
                        <li class="page-item required"><a class="page-link" href="#" tabindex="-1" aria-required="true">Previous</a></li>
