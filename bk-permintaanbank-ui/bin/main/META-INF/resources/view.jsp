...
<div class="container my-3">
	<div class="card">
		<div style="background-color: #830000; color: #fff"
			class="card-header">
			<h4 class="m-0">
				<i class="fa fa-th-list"></i> Permintaan Bank
			</h4>
		</div>
		<div class="card-body">
			<form>
	...
	<div class="w3-modal-content w3-animate-zoom">
		...
		<div class="w3-container pb-3">
			<form>
				...
				<div class="form-group row">
					<label for="staticEmail" class="col-sm-4 col-form-label">Nama Pemohon</label>
					<div class="col-sm-8">
						<input type="text" class="form-control" disabled>
					</div>
				</div>
				...
				<div class="form-group row">
					<label for="staticEmail" class="col-sm-4 col-form-label">Unggah Logo Bank</label>
					<div class="col-sm-8">
