...
<div class="container my-3">
	<div class="card">
		<div style="background-color: #830000; color: #fff"
			class="card-header">
			<h4 class="m-0">
				<i class="fa fa-list-alt"></i> Role Pengguna
			</h4>
		</div>
		<div class="card-body">
			<form>
				...
				<tbody>
					<tr>
						...
						<td><a href="javascript:void(0)"
							...
							data-toggle="tooltip" data-placement="top" title="Lihat Role"><i
								class="fa fa-eye"></i></a></td>
						<td><a href="javascript:void(0)"
							onclick="document.getElementById('id02').style.display='block'"
							data-toggle="tooltip" data-placement="top" title="Ubah Role"><i
						...
						<td><a href="javascript:void(0)"
							...
							data-toggle="tooltip" data-placement="top" title="Hapus Role"><i
